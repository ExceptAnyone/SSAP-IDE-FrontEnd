    ...
    return (
        <div>
            ...
            <div>
                    ...
                    <button onClick={handleCreateClick} disabled={isNameEmpty}>생성하기</button>
                </div>
            <form className='editcontain'>
                <div>
                    <div className='edit-1'>이름
                    <input
                        type="text"
                        value={name}
                ...
                <div>
                <div className='edit-2'>추가 모듈/패키지
